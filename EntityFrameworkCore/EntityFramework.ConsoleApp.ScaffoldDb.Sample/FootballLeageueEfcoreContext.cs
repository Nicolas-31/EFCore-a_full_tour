...
public partial class FootballLeageueEfcoreContext : DbContext
{
    public FootballLeageueEfcoreContext()
    {
    }

    public FootballLeageueEfcoreContext(DbContextOptions<FootballLeageueEfcoreContext> options)
        : base(options)
    {
    }
